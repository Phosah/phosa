<template>
    <div class="mb-12 flex justify-center space-x-3">
        ...
        <div class="w-10 h-10 flex items-center justify-center bg-[#202020] hover:bg-brand-gray rounded-full">
            <a href="mailto:efosa.uyi@gmail.com" target="_blank">
                <img class src="../assets/email.png" alt="Email" />
            </a>
        </div>
        <div class="w-10 h-10 flex items-center justify-center bg-[#202020] hover:bg-brand-gray rounded-full">
            <a href="https://www.linkedin.com/in/efosa-uyi-idahor-00a519157/" target="_blank">
                <img class src="../assets/linkedin.png" alt="LinkedIn" />
            </a>
        </div>
        <div class="w-10 h-10 flex items-center justify-center bg-[#202020] hover:bg-brand-gray rounded-full">
            <a href="https://github.com/Phosah" target="_blank">
